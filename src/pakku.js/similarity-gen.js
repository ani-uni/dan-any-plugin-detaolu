  ...
  var N = (a) => {
    ...
    S = {
      ...
      emscripten_resize_heap: (a) => {
        ...
        if (268435456 < a)
          return (
            t(`Cannot enlarge memory, requested ${a} bytes, but the limit is ${268435456} bytes!`),
            !1
          );
        for (var c = 1; 4 >= c; c *= 2) {
          var h = b * (1 + 1 / c);
            ...
            if (0 === e || 10 === e) {
              ...
              if (16 < u - l && e.buffer && P) e = P.decode(e.subarray(l, u));
                ...
                for (p = ""; l < u; ) {
                  ...
                  if (d & 128) {
                    var G = e[l++] & 63;
                    if (192 == (d & 224)) p += String.fromCharCode(((d & 31) << 6) | G);
                    else {
                      var Q = e[l++] & 63;
                      if (224 == (d & 240)) d = ((d & 15) << 12) | (G << 6) | Q;
                        ...
                        d = ((d & 7) << 18) | (G << 12) | (Q << 6) | (e[l++] & 63);
                      }
                      65536 > d
                        ? (p += String.fromCharCode(d))
                        : ((d -= 65536),
                          (p += String.fromCharCode(55296 | (d >> 10), 56320 | (d & 1023))));
                    }
